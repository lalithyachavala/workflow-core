...
"[project]/apps/web/app/api/admin/dashboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$request$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])(req, "dashboard", "read");
    if (!auth.allowed) {
    ...
    const [totalEmployees, todaySessions, pendingPunches] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].countDocuments({
            isActive: true
        }),
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WorkSession"].find({
            clockInAt: {
                $gte: todayStart,
                $lte: todayEnd
            }
        }).lean(),
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WorkSession"].countDocuments({
            clockInAt: {
                $gte: todayStart,
                $lte: todayEnd
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cabdbbf5._.js.map