...
"[project]/apps/web/src/biometric/face.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getKeyBuffer() {
    const hex = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].faceEmbeddingKey.replace(/[^0-9a-fA-F]/g, "");
    if (hex.length !== 64) {
...
function decryptEmbedding(encryptedBase64) {
    const key = getKeyBuffer();
...
async function updateProfilePicture(userId, imageBase64) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findByIdAndUpdate(userId, {
        "profile.profilePictureBase64": imageBase64
    });
}
async function enrollFace(userId, embedding, pose, profileImageBase64) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FaceTemplate"].findOneAndUpdate({
        userId
    }, {
        [field]: encrypted,
...
async function verifyFace(userId, embedding) {
    if (!Array.isArray(embedding) || embedding.length !== 512) {
        return {
            score: 0,
            accepted: false,
    ...
    const template = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FaceTemplate"].findOne({
        userId
    }).lean();
    if (!template) {
        return {
    ...
    return {
        score: bestScore,
        accepted,
        reason: accepted ? "matched" : "below_threshold"
    };
}
}),
"[project]/apps/web/app/api/auth/enroll-face/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$biometric$2f$face$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/biometric/face.ts [app-route] (ecmascript)");
;
;
;
;
...
const bodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    embedding: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number()).length(512),
    pose: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        "front",
        "left",
        "right"
    ]),
    profileImageBase64: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional()
});
async function POST(req) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$biometric$2f$face$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrollFace"])(user.sub, parsed.data.embedding, parsed.data.pose, parsed.data.profileImageBase64);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
        });
    } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af5cdddd._.js.map