...
"[project]/apps/web/app/api/admin/attendance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$request$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])(req, "attendance", "read");
    if (!auth.allowed) {
    ...
    const events = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$db$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AttendanceEvent"].find().sort({
        timestamp: -1
    }).limit(100).populate("userId", "email profile").populate("deviceId", "hostname osVersion appVersion deviceFingerprint").lean();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        events
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8e2aff53._.js.map